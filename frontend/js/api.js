...
const Api = (() => {
  ...
  return {
    ...
    getDeviceBridge: (id) => request(`/devices/${id}/bridge`),
    getDevicePrinter: (id) => request(`/devices/${id}/printer`),
    ...
    listLinks: () => request('/topology/links'),
    getLink: (id) => request(`/topology/links/${id}`),

    listSeeds: () => request('/discovery/seeds'),
    createSeed: (data) => request('/discovery/seeds', { method: 'POST', body: JSON.stringify(data) }),
    updateSeed: (id, data) => request(`/discovery/seeds/${id}`, { method: 'PATCH', body: JSON.stringify(data) }),
    ...
    assignCredentials: (data) => request('/credentials/assign', { method: 'POST', body: JSON.stringify(data) }),
    getDeviceCredentials: (id) => request(`/devices/${id}/credentials`),
    ...
    traceDevice: (q) => request('/trace/device' + qs({ q })),
    traceVlan: (vlanId) => request(`/trace/vlan/${vlanId}`),
    listVlans: () => request('/vlans'),
    getVlan: (vlanId) => request(`/vlans/${vlanId}`),
    updateVlan: (vlanId, body) => request(`/vlans/${vlanId}`, { method: 'PATCH', body: JSON.stringify(body) }),
